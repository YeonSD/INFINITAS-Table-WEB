...
function syncMobileRankScale(viewMode = 'normal') {
  lastMobileRankViewMode = viewMode || lastMobileRankViewMode;
...
function ensureMobileRankScaleResize() {
  ...
  if (typeof window === 'undefined') return;
  window.addEventListener('resize', () => syncMobileRankScale(lastMobileRankViewMode));
