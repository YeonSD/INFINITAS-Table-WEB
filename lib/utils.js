...
export function normalizeSocialSettings(s) {
  ...
  return {
    ...
    shareRankTableWithMutuals: src.shareRankTableWithMutuals !== false,
    goalTransferPolicy,
...
export function normalizeLamp(raw) {
  ...
  const map = { NP: 'NP', NOPLAY: 'NP', F: 'F', FAILED: 'F', AC: 'ASSIST', ASSIST: 'ASSIST', EX: 'EX', EXHARD: 'EX', HC: 'HC', HARD: 'HC', FC: 'FC', EC: 'EASY', EASY: 'EASY', NC: 'NORMAL', NORMAL: 'NORMAL' };
  return map[v] || 'NP';
}
