...
import { renderAccountInfo, renderGraphs, renderMedals, renderPeerRankViewer, renderRankTable } from './rank-ui.js';
...
export function showSongPopup(chart, event, isAuthorized, options = {}) {
  ...
  $('popupTitle').innerHTML = `<span class="song-popup-headline">${esc(`${chart.title} [${chart.type}]`)}</span><span class="song-popup-actions">${goalBtn}${editBtn}</span>`;
