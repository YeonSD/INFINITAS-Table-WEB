...
export const SCORE_GRAPH_ORDER = ['NOPLAY', 'F', 'E', 'D', 'C', 'B', 'A', 'AA', 'AAA', 'MAX-', 'MAX'];
export const SCORE_SUMMARY_ORDER = ['MAX', 'MAX-', 'AAA', 'AA', 'A', 'B', 'C', 'D', 'E', 'F', 'NOPLAY'];
...
export const DEFAULT_SOCIAL_SETTINGS = Object.freeze({
  ...
  shareRankTableWithMutuals: true,
